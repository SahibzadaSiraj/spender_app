    ...
    return Column(
      ...
      children: [
          ...
          child: SizedBox(
              ...
              child: controller.tabController.index == 0
                  ...
                  : Image(
                      ...
                      image: const Svg("assets/images/income_money.svg"))),
        ),
        const SizedBox(
          height: 8,
        ),
                      ...
                      if ((value != "" &&
                        ...
                        if (controller.selectedItemDropDown!.value == 'EUR') {
                          ...
                          controller.transactionAmount.value = (deger *
                              ...
                              .toStringAsFixed(2);
                          return '£ = ${homeController.eurToTl.value}€ => ${controller.transactionAmount.value}€';
                        }
                      }
                      if ((value != "" &&
                          homeController
                        ...
                        if (controller.selectedItemDropDown!.value == 'USD') {
                          ...
                          controller.transactionAmount.value = (deger *
                              ...
                              .toStringAsFixed(2);
                          return '£ = ${homeController.usdToTl.value}\$ => ${controller.transactionAmount.value}\$';
                        }
                      }
                      if ((value != "" &&
                          homeController
                              ...
                              '£')) {
                        double deger = double.parse(value.toString());
                        if (controller.selectedItemDropDown!.value == 'GBP') {
                          controller.transactionAmount.value = value!;
                          return null;
                        } else if (controller.selectedItemDropDown!.value ==
                            'USD') {
                          controller.transactionAmount.value = (deger *
                                  double.parse(
                                      homeController.dovizKurlari[0].usdKur))
                              .toStringAsFixed(2);
                          return '1\$ = ${(double.parse(homeController.dovizKurlari[0].usdKur).toStringAsFixed(2))}£ => ${controller.transactionAmount.value}£';
                        } else if (controller.selectedItemDropDown!.value ==
                            'EUR') {
                          controller.transactionAmount.value = (deger *
                                  double.parse(
                                      homeController.dovizKurlari[0].eurKur))
                              .toStringAsFixed(2);
                          return '1€ = ${(double.parse(homeController.dovizKurlari[0].eurKur).toStringAsFixed(2))}£ => ${controller.transactionAmount.value}£';
                        }
                      }
                      return null;
                    },
        ...
        Container(
          ...
          height: MediaQuery.of(context).size.height * 0.07,
          decoration: BoxDecoration(
              color: const Color.fromARGB(228, 245, 245, 245),
              borderRadius: BorderRadius.circular(10)),
          child: Padding(
            padding:
                const EdgeInsets.only(left: 10, right: 18, top: 10, bottom: 10),
        ...
        Container(
          ...
          child: Padding(
            padding:
                const EdgeInsets.only(right: 15, left: 15, top: 10, bottom: 2),
            child: Column(
