...
class HomeController extends GetxController with StateMixin {
  ...
  getDovizKurlari() async {
    ...
    eurToUsd.value = (double.parse(dovizKurlari[0].eurKur) /
            double.parse(dovizKurlari[0].usdKur))
        .toStringAsFixed(2);
    usdToEur.value = (double.parse(dovizKurlari[0].usdKur) / double.parse(dovizKurlari[0].eurKur)).toStringAsFixed(2);
    eurToTl.value =
        (1 / double.parse(dovizKurlari[0].eurKur)).toStringAsFixed(3);
    usdToTl.value =
        (1 / double.parse(dovizKurlari[0].usdKur)).toStringAsFixed(3);
  }
