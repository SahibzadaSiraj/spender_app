    ...
    switch (i) {
      case 0:
        return PieChartSectionData(
          color: Color(int.parse(ExpenseModel.expenseItems[0].color!))
              .withOpacity(opacity),
      ...
      case 1:
        return PieChartSectionData(
          color: Color(int.parse(ExpenseModel.expenseItems[1].color!))
              .withOpacity(opacity),
      ...
      case 2:
        return PieChartSectionData(
          color: Color(int.parse(ExpenseModel.expenseItems[2].color!))
              .withOpacity(opacity),
      ...
      case 3:
        return PieChartSectionData(
          color: Color(int.parse(ExpenseModel.expenseItems[3].color!))
              .withOpacity(opacity),
      ...
      case 4:
        return PieChartSectionData(
          color: Color(int.parse(ExpenseModel.expenseItems[4].color!))
              .withOpacity(opacity),
...
class _HomePageState extends State<HomePage> {
  ...
  Widget rollingIconBuilder(int value, Size iconSize, bool foreground) {
    ...
    for (var element in homeController.wallets) {
      icons.add(
