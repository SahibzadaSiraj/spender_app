...
class Event extends StatefulWidget {
  ...
  @override
  State<Event> createState() => _WalletsPageState();
}

class _WalletsPageState extends State<Event> {
          ...
          child: Scaffold(
              ...
              body: Column(
                  ...
                  children: [
                    ...
                    //         for (var elementCurrent in homeController.wallets) {
                    //           int index1 = 0;
                    //           for (var element in walletController.wallets) {
