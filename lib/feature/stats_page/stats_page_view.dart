...
class _StatsPageState extends State<StatsPage> {
  ...
  Widget build(BuildContext context) {
    return statsController.obx(
      ...
      DateTime queryDate = currentDate.subtract(const Duration(days: 30));
  ...
  List<BarChartGroupData> makeGroupExpenses() {
    ...
    int x = 0;
    for (var element in statsController.statsYuzde) {
      grafikListe.add(BarChartGroupData(
          ...
          barRods: [
            BarChartRodData(
                ...
                width: 40,
                color:
                    Color(int.parse(ExpenseModel.expenseItems[x].color!))
                        .withOpacity(0.6))
          ]));
      x++;
    }
