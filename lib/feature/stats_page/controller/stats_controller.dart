...
//------------Incomes,Expenses Toplam
  ...
  statsYuzdeHesaplama() {
    ...
    statsYuzde.insert(0, (travelToplam * 100) / grafikToplam.value);
    statsYuzde.insert(1, (foodToplam * 100) / grafikToplam.value);

    statsYuzde.insert(2, (shoppingToplam * 100) / grafikToplam.value);
    statsYuzde.insert(3, (billingToplam * 100) / grafikToplam.value);
    statsYuzde.insert(4, (otherToplam * 100) / grafikToplam.value);

    for (var element in statsYuzde) {
      if (element > 50) {
  ...
  statsIncomeYuzdeHesaplama() {
    ...
    for (var element in statsIncomes) {
