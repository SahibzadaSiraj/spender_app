...
class WalletOnboardPage extends StatefulWidget {
  const WalletOnboardPage({super.key});
          ...
          children: [
            ...
            Center(
              child: ElevatedButton(
                onPressed: () async {
                  if (enabledWalletAmount != 0 && (_controllers[0].text != "" || _controllers[1].text != "" || _controllers[2].text !="" )) {
                    walletController.selectedWallet(_controllers);
                    ...
                    QuickAlert.show(
                        ...
                        text:
                            'Please activate at least 1 wallet in your account and enter your budget.');
                  }
                },
